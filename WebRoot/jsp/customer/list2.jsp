											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="stardate" value="${stardate}"></TD>
													<TD>截止时间：</TD>
													<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="enddate" value="${enddate}"></TD>
													<TD><INPUT class=button id=sButton2 type=submit
														value=" 筛选 " name=sButton2></TD>
													<TD>总收入：</TD> 
													<TD style=" font-size: 25px; color: red">${zjq}元</TD>
												</TR>
											</TBODY>
										</TABLE>
									</TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													&nbsp;
													<c:if test="${mss!='0'}"><a href="customer_delete.action?id=${customer.id}">删除</a></c:if>
												</TR>
												</s:iterator>
											</TBODY>
										</TABLE>
